    ...
    <div class="container-fluid">
        <div class="col-12 pt-4">
            <div class="card shadow-sm border-0">
                <x-card-header title="CREAR ASIGNACION" icon="fa-solid fa-file-circle-plus">
                        ...
                        <div class="row g-3">
                                ...
                                <select class="form-control selectpicker" data-size="5" data-live-search="true"
                                    ...
                                    @foreach ($bosses as $boss)
                                        <option value="{{ $boss->idBoss }}"
                                            {{ old('Boss_id') == $boss->idBoss ? 'selected' : '' }}>
                            ...
                            <div class="col-md-3">
                                ...
                                <small class="text-info d-block mt-1">
                                    <i class="fa-solid fa-lightbulb"></i> Deje vacío y presione buscar para ver todos los
                                    equipos disponibles
                                </small>
                            </div>

                            <div class="col-12">
                                <label class="form-label fw-semibold">Equipos a asignar: <span
                                        class="text-danger">*</span></label>
                                <div id="selected_equipments" class="border rounded p-3 bg-light">
                                    <p class="text-muted mb-0">No hay equipos seleccionados. Use la búsqueda para agregar
                                        equipos.</p>
                                </div>
        ...
        async function loadSelectedEquipmentsData() {
            ...
            try {
                const response = await fetch(
                    `{{ route('asignacion.search-equipment') }}?search=&get_selected=true&ids=${selectedEquipments.join(',')}`
                    );
                if (response.ok) {
