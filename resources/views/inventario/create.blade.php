        ...
        @can('Crear-Inventario')
            <div class="col-12 pt-4">
                <div class="card shadow-sm border-0">
                    <x-card-header title="AGREGAR EQUIPO" icon="fa-solid fa-computer">
                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control selectpicker show-tick" data-size="5" data-live-search="true"
                                        id="EquipmentType_id" name="EquipmentType_id" required>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="Model" name="Model"
                                        placeholder="SNF-555" value="{{ old('Model') }}" required>
                                    @error('Model')
                                        <small class="text-danger">{{ '*' . $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control selectpicker show-tick" data-size="5" data-live-search="true"
                                        ...
                                        <option value="1" {{ old('status') == '1' ? 'selected' : '' }}>Disponible
                                        </option>
                                        <option value="2" {{ old('status') == '2' ? 'selected' : '' }}>Por preparar
                                        </option>
                                        <option value="3" {{ old('status') == '3' ? 'selected' : '' }}>En uso</option>
                                        <option value="4" {{ old('status') == '4' ? 'selected' : '' }}>Observación
                                        </option>
                                        <option value="5" {{ old('status') == '5' ? 'selected' : '' }}>R Pendiente
                                        </option>
                                        <option value="6" {{ old('status') == '6' ? 'selected' : '' }}>No devuelto
                                        </option>
                                        <option value="7" {{ old('status') == '7' ? 'selected' : '' }}>Perdida-Robo
                                        </option>
