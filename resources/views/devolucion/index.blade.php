                            ...
                            @foreach ($returns as $return)
                                ...
                                <x-modal-base id="modalEditar{{ $return->id }}"
                                    ...
                                    <form action="{{ route('devolucion.update', $return->id) }}" method="POST"
                                        enctype="multipart/form-data" class="row" id="formEditar{{ $return->id }}">
                                        @csrf
                                        @method('PUT')
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p><strong>Equipo:</strong> {{ $return->equipment->CodigoPatri ?? 'N/A' }}
                                                </p>
                                ...
                                @if ($return->Document)
                                    <x-btn-documento id="modalDocu{{ $return->id }}"
                                        ...
                                        <embed src="{{ asset('storage/' . $return->Document) }}" type="application/pdf"
