    ...
    public function store(Request $request)
{
    $request->validate([
        ...
        'Date' => 'required|date',
        'estado' => 'required|in:1,2,4,5', // Quitar el 6 ya que no existe en las opciones
    ...
    try {
        ...
        // Determinar si se devolvió basado en el estado
        // Si el estado es 1 (Disponible) significa que se devolvió completamente
        $devolucion = ($request->estado == 1) ? 1 : 0;

        // Crear registro de devolución - GUARDAR EL ESTADO AQUÍ TAMBIÉN
    ...
    public function update(Request $request, $id)
{
    ...
    try {
        ...
        // Manejar el estado en assigned_team
 ...
 public function destroy($id)
{
    try {
        ...
        // Reactivar la asignación en assigned_team
